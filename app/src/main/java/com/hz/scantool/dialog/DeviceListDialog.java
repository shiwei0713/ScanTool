...
import com.hz.scantool.adapter.SearchSelectAdapter;
...
public class DeviceListDialog extends Dialog {
    ...
    public DeviceListDialog(Context mContext,int themeResId){
    ...
    **/
    public void setDialogWindowAttr(double x, double y, Activity activity){
        ...
        layoutParams.width = (int)(width * x);
    ...
    public static class Builder{
        ...
        public Builder(Context context) {
            ...
            dialog = new DeviceListDialog(context,R.style.selectDialog);
         ...
         */
        private DeviceListDialog create() {
        ...
        public void setSelectedListiner(DeviceListDialog.Builder.OnSelectedListiner selectedListiner) {
