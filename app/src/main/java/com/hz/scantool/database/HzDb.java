...
@Database(entities = {DeliveryOrderEntity.class,LabelEntity.class,ProductEntity.class,MergeLabelEntity.class,QrcodeEntity.class,CheckLabelEntity.class},version = 2)
public abstract class HzDb extends RoomDatabase {
    ...
    public abstract CheckLabelDao checkLabelDao();
}
